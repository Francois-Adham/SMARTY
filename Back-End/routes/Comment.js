const { isInstructor, isEnrolled,isOwnedPost,isOwnedComment, isLoggedIn } = require("../middleware");
...
router.post('/create',isLoggedIn,(req,res)=>{
    Comment.create({body:req.body.body,publisher:req.user},(err,comment)=>{
        if(err)
        {
            console.log(err);
